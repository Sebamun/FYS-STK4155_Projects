...
from plot import plot_bias_accuracy, plot_bias_accuracy_simple, plot_R2_score
from common import prepare_data, MSE
...
def run_kfold_DNN(act_funcs):
    ...
    #plot_R2_score(loss_2, val_loss_2, N_epochs, act_funcs)
...
# I denne delen skal vi undersøke noen forskjellige støy verdier:
...
# implementer en lettere modell og sammenlign denne med lossen vi får fra den vanlige modellen, som feks median
